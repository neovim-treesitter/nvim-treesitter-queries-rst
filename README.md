# nvim-treesitter-queries-rst

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-rst/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-rst/actions/workflows/validate.yml)

Neovim tree-sitter queries for **rst**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-rst",
...
- [ ] Changes are scoped to `rst` — do not include files for other languages
